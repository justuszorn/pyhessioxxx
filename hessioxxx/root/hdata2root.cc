...
Copyright (C) 2002, 2009 Konrad Bernloehr (Konrad Bernl&ouml;hr)
 ...
 *  @date    @verbatim CVS $Date: 2011/10/31 17:32:07 $ @endverbatim
 *  @version @verbatim CVS $Revision: 1.18 $ @endverbatim
 */
