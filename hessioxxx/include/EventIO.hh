...
#if defined(_CPP_VECTOR) || defined(__SGI_STL_VECTOR) || defined(_GLIBCXX_VECTOR)
#define HAVE_STD_VECTOR 1
#endif

#if defined(_CPP_VALARRAY) || defined(__STD_VALARRAY__) || defined(_GLIBCXX_VALARRAY)
#define HAVE_STD_VALARRAY 1
#endif

#if defined(_CPP_STRING) || defined(__BASTRING__) || defined(_GLIBCXX_STRING)
...
long GetLong(void) { long val = (long) GetInt64() ; return val; } 
...
//               else check_throw("Put"); }
   ...
   class EventIO
   {
      ...
      friend class eventio::Item;

      private:
         IO_BUFFER *iobuf;
         eventio::Item *toplevel;
   ...
   typedef class Item EventIO_Item;
